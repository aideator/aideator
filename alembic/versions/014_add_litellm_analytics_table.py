...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Raw LiteLLM data
        sa.Column("litellm_metadata", postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index("idx_litellm_analytics_variation_id", "litellm_analytics", ["variation_id"])
    op.create_index("idx_litellm_analytics_request_id", "litellm_analytics", ["request_id"])
    ...
    op.create_index("idx_litellm_analytics_request_start_time", "litellm_analytics", ["request_start_time"])
    op.create_index("idx_litellm_analytics_created_at", "litellm_analytics", ["created_at"])
    
    # Composite indexes for common analytics queries
    op.create_index("idx_litellm_analytics_run_variation", "litellm_analytics", ["run_id", "variation_id"])
    op.create_index("idx_litellm_analytics_model_provider", "litellm_analytics", ["model", "provider"])
    op.create_index("idx_litellm_analytics_cost_analysis", "litellm_analytics", ["provider", "model", "cost_usd"])
