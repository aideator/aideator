...
class TestModelSyncServiceFixes:
    ...
    def test_process_model_handles_none_values(self, service, mock_session, sample_model_data):
    ...
    def test_process_model_updates_existing_with_none_handling(self, service, mock_session, sample_model_data):
    ...
    def test_fetch_models_uses_master_key_auth(self, mock_client, service):
        ...
        info_response.json.return_value = {"data": [{"model_name": "gpt-4", "litellm_provider": "openai"}]}
    ...
    def test_sync_models_is_idempotent(self, service, mock_session):
        ...
        with patch.object(service, '_fetch_models_from_proxy', return_value=sample_models):
            with patch.object(service, '_process_model') as mock_process:
                with patch.object(service, '_deactivate_missing_models'):
                    ...
                    assert mock_session.rollback.called  # Rollback was called for the duplicate

    def test_provider_field_is_set_correctly(self, service, mock_session, sample_model_data):
