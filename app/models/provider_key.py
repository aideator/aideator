...
class ProviderAPIKeyDB(SQLModel, table=True):
    ...
    model_name: Optional[str] = Field(default=None, index=True, description="Optional: specific model override")
    ...
    # Metadata
    name: Optional[str] = Field(default=None, description="User-friendly name for this key")
    description: Optional[str] = Field(default=None, description="Optional description")
    
    # Status and tracking
    is_active: bool = Field(default=True, index=True)
    is_valid: Optional[bool] = Field(default=None, description="Last validation status")
    last_validated_at: Optional[datetime] = Field(default=None)
    last_used_at: Optional[datetime] = Field(default=None)
    last_error: Optional[str] = Field(default=None, description="Last error message if validation failed")
