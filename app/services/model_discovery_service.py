...
class ModelDiscoveryService:
    ...
    def get_all_possible_models(self, provider_keys: Dict[str, str] | None = None) -> List[Dict[str, Any]]:
        """
    ...
    def _discover_models_from_providers(self, provider_keys: Dict[str, str]) -> List[Dict[str, Any]]:
    ...
    def _deduplicate_and_enrich_models(self, models: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for model in models:
            ...
            enriched = {
                **model,
                ...
                'description': self._generate_description(model_name, model.get('litellm_provider')),
                'category': self._determine_category(model_name, model.get('litellm_provider')),
    ...
    def _generate_display_name(self, model_name: str) -> str:
        ...
        name = model_name
        for prefix in ['openai/', 'anthropic/', 'vertex_ai/', 'bedrock/', 'azure/', 'groq/', 'mistral/', 'deepseek/', 'xai/']:
