...
class GlobalKeyService:
    ...
    def has_provider_key(self, provider: str, user_id: Optional[str] = None) -> bool:
        """Check if API key exists for provider."""
        return self.get_provider_key(provider, user_id) is not None
    
    def get_available_providers(self, user_id: Optional[str] = None) -> Dict[str, bool]:
    ...
    def get_kubernetes_env_vars(self, user_id: Optional[str] = None) -> Dict[str, str]:
