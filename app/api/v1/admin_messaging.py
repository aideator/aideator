...
async def get_active_runs(
    db: AsyncSession, include_completed: bool = False, limit: int = 10
) -> list[dict[str, Any]]:
...
async def cleanup_database(
    db: AsyncSession, older_than_days: int = 7, dry_run: bool = True
) -> dict[str, Any]:
...
async def database_health(db: AsyncSession) -> dict[str, Any]:
...
async def get_overview(
    ...
    # Total runs and messages from stats
